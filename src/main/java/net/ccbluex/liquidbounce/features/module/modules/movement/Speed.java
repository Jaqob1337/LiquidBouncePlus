...
public class Speed extends Module {
    ...
    public final ListValue hypixelModeValue = new ListValue("Hypixel-Mode", new String[]{"Boost", "Universocraft", "Custom"}, "Universocraft", () -> typeValue.get().equalsIgnoreCase(" ")) { // the worst hypixel bypass ever existed
    ...
    public final FloatValue moveSpeedValue = new FloatValue("MoveSpeed", 1.47F, 1F, 3F, () -> (typeValue.get().equalsIgnoreCase("hypixel") && !getModeName().equalsIgnoreCase("hypixelcustom")));
